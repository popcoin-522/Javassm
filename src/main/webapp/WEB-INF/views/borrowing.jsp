        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="bi bi-arrow-left-right"></i> 借阅管理</h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">选择状态为"可下载"的文档进行借阅，系统将自动更新文档状态并记录借阅信息</p>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">查看所有借阅记录，监控文档使用情况，包括借阅时间和归还时间</p>
                ...
                <c:if test="${not empty records}">
                    <div class="card mt-4">
                        <div class="card-header">
                            <h6 class="mb-0"><i class="bi bi-graph-up"></i> 借阅记录统计</h6>
                        </div>
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col-md-3">
